...
export default function Layout(props: ParentProps) {
  ...
  const isMobile = createMemo(() => platform.platform === "android")
  ...
  return (
    <Show
      when={!isMobile()}
      fallback={
        <div class="flex flex-col h-dvh" data-platform="android">
          <div class="flex-1 overflow-hidden" data-component="main-content" style={{ "padding-bottom": "calc(56px + var(--sab, 0px))" }}>
            {props.children}
          </div>
        </div>
      }
